...
namespace OpenTKEngine.Entities.Components
{
    public class SpotLightComponent : Component
    {
        ...
        public SpotLightComponent(Shader shader, Vector3? ambient = null, Vector3? diffuse = null, Vector3? specular = null, float? constant = null, float? linear = null, float? quadratic = null, float? cutOff = null, float? outerCutOff = null)
        {
            _shader = shader;
        ...
        public override void Draw()
        {
            ...
            _shader.SetVector3("spotLight.position", camera.Entity.Transform.Position);
