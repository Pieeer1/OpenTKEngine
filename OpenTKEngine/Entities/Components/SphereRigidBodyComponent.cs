...
namespace OpenTKEngine.Entities.Components
{
    public class SphereRigidBodyComponent : RigidBodyComponent
    {
        ...
        public override void Init()
        {
            ...
            _handle = PhysicsService.Instance.Simulation.Bodies.Add(BodyDescription.CreateDynamic(DataManipulationService.OpenTKVectorToSystemVector(Entity.Transform.Position), inertia, PhysicsService.Instance.Simulation.Shapes.Add(_sphere), 0.01f));
