...
namespace OpenTKEngine.Entities.Components
{
    public class BoxRigidComponent : RigidBodyComponent
    {
        ...
        public override void Init()
        {
            ...
            _handle = PhysicsService.Instance.Simulation.Bodies.Add(BodyDescription.CreateDynamic(DataManipulationService.OpenTKVectorToSystemVector(Entity.Transform.Position), inertia, PhysicsService.Instance.Simulation.Shapes.Add(Box), 0.01f));
