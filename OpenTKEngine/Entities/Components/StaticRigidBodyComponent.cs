...
namespace OpenTKEngine.Entities.Components
{
    public class StaticRigidBodyComponent : RigidBodyComponent
    {
        ...
        public override void Init()
        {
            ...
            PhysicsService.Instance.Simulation.Statics.Add(new StaticDescription(new System.Numerics.Vector3(0, 0, 0), PhysicsService.Instance.Simulation.Shapes.Add(new Box(Entity.Transform.Scale.X * 2500, 1.0f, Entity.Transform.Scale.Y * 2500))));
